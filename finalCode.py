...
def crossOver(parent1, parent2):
    ...
    while (condition):
        ...
        # x1y1FirstHalf = x1y1[:randomNumberToMakeACut]
        # x1y1SecondHalf = x1y1[randomNumberToMakeACut:]
        # x2y2FirstHalf = x2y2[:randomNumberToMakeACut]
        # x2y2SecondHalf = x2y2[randomNumberToMakeACut:]
        # x1y1 = x1y1FirstHalf + x2y2SecondHalf
        # x2y2 = x2y2FirstHalf + x1y1SecondHalf
